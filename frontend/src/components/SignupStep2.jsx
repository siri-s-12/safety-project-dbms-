...
const SignupStep2 = ({ formData, setFormData, errors, onContinue, onSkip, isLoading }) => {
  ...
  return (
    <div className="fade-in">
      ...
      <div className="bg-[#FFF5F7] border-l-4 border-[#a8b86e] p-6 rounded-lg mb-8">
        <div className="flex items-start gap-3">
          <span className="text-2xl">⚠️</span>
          <div>
            <h3 className="font-semibold text-[#7a8a42] mb-2">
          ...
          <input
            ...
            className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none transition-colors ${
              errors.emergencyContactName 
                ? 'border-red-500' 
                : 'border-gray-300 focus:border-[#7a8a42] focus:ring-2 focus:ring-[#7a8a42]'
            }`}
          />
          {errors.emergencyContactName && (
      ...
      <div className="flex justify-between gap-4 mt-8">
        ...
        <button
          onClick={onSkip}
          disabled={isLoading}
          className="flex-1 py-3 px-6 border-2 border-[#7a8a42] text-[#7a8a42] font-semibold rounded-lg hover:bg-[#F5F1E8] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <button
          onClick={onContinue}
          disabled={isLoading}
          className="flex-1 py-3 px-6 bg-[#7a8a42] text-white font-semibold rounded-lg hover:bg-[#6B2A4A] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
