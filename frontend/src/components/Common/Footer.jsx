...
export default function Footer() {
    return (
        <footer className="bg-[#3a3520] w-full pt-16 pb-8 text-sm font-body">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-12 max-w-[1440px] mx-auto">
                <div className="col-span-1 md:col-span-1">
                    <div className="text-xl font-bold text-white font-headline mb-4 tracking-tight">Nirbhaya</div>
                    <p className="text-stone-300 mb-6 italic">The Sovereign Sanctuary.</p>
                    <p className="text-stone-300 text-xs">© 2024 Nirbhaya. All rights reserved.</p>
                </div>
