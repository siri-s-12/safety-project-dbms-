...
export default function Sidebar() {
    ...
    return (
        <nav className="hidden md:flex flex-col fixed left-0 top-0 h-screen z-50 py-6 bg-[#faf8f2] dark:bg-stone-950 text-[#8d9d4f] dark:text-[#a8b86e] font-['Manrope'] font-medium text-sm tracking-wide w-72 border-r border-stone-100 dark:border-stone-800 shadow-none">
            {/* Header */}
            <div className="px-8 pb-8 flex items-center gap-4">
                ...
                <div>
                    <h2 className="font-headline text-xl italic text-[#8d9d4f]">The Guardian</h2>
            ...
            <ul className="flex-1 flex flex-col gap-2 mt-4 pr-6">
                <li>
                    <Link to="/dashboard" className={`flex items-center gap-4 px-8 py-3 rounded-r-full active:scale-98 transition-all duration-300 ${isActive('/dashboard') ? 'text-[#8d9d4f] dark:text-[#a8b86e] font-bold bg-[#e7dbbf] dark:bg-[#8d9d4f]/20' : 'text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-900 hover:pl-2'}`}>
                        <span className="material-symbols-outlined" data-icon="shield_with_heart">shield_with_heart</span>
                        <span>Sanctuary</span>
                    </Link>
                </li>
                <li>
                    <Link to="/map" className={`flex items-center gap-4 px-8 py-3 rounded-r-full active:scale-98 transition-all duration-300 ${isActive('/map') ? 'text-[#8d9d4f] dark:text-[#a8b86e] font-bold bg-[#e7dbbf] dark:bg-[#8d9d4f]/20' : 'text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-900 hover:pl-2'}`}>
                        <span className="material-symbols-outlined" data-icon="explore">explore</span>
                        <span>Atelier Maps</span>
                    </Link>
                </li>
                <li>
                    <Link to="/pricing" className={`flex items-center gap-4 px-8 py-3 rounded-r-full active:scale-98 transition-all duration-300 ${isActive('/pricing') ? 'text-[#8d9d4f] dark:text-[#a8b86e] font-bold bg-[#e7dbbf] dark:bg-[#8d9d4f]/20' : 'text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-900 hover:pl-2'}`}>
                        <span className="material-symbols-outlined" data-icon="menu_book">menu_book</span>
                        <span>Pricing</span>
                    </Link>
                </li>
                <li>
                    <Link to="/payment" className={`flex items-center gap-4 px-8 py-3 rounded-r-full active:scale-98 transition-all duration-300 ${isActive('/payment') ? 'text-[#8d9d4f] dark:text-[#a8b86e] font-bold bg-[#e7dbbf] dark:bg-[#8d9d4f]/20' : 'text-stone-600 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-900 hover:pl-2'}`}>
