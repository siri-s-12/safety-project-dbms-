...
export default function StatsSection() {
  return (
    <section className="py-24 bg-gradient-to-br from-[#3a3520] to-[#2c2a1e] relative overflow-hidden">
      {/* Subtle decorative elements */}
      <div className="absolute top-0 left-0 w-72 h-72 bg-[#8d9d4f]/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#8d9d4f]/10 rounded-full blur-3xl translate-x-1/3 translate-y-1/3"></div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
          {STATS.map((stat, i) => (
            ...
            >
              <div className="w-14 h-14 rounded-full bg-[#8d9d4f]/30 flex items-center justify-center mb-5">
