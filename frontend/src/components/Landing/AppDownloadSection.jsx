...
export default function AppDownloadSection() {
  return (
    <section className="py-24 bg-gradient-to-br from-[#8d9d4f] to-[#3a3520] relative overflow-hidden">
      {/* Decorative blobs */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-headline text-4xl lg:text-5xl font-bold text-white tracking-tight mb-6 leading-tight">
              Keep Nirbhaya<br />In Your Pocket
            </h2>
          ...
          <div className="hidden lg:flex justify-center">
            <div className="relative w-[280px]">
              ...
              <div className="bg-[#1a0a12] rounded-[40px] p-3 shadow-2xl shadow-black/40 border border-white/10">
                ...
                {/* Screen */}
                <div className="bg-[#faf8f2] rounded-[28px] overflow-hidden">
                  {/* Status bar */}
                  <div className="h-10 bg-[#3a3520] flex items-center justify-between px-5">
                  ...
                  {/* App header */}
                  <div className="px-5 pt-4 pb-3 bg-white border-b border-[#f5f0e0]">
                    <div className="flex items-center gap-2">
                      <div className="w-7 h-7 rounded-full bg-[#8d9d4f] flex items-center justify-center">
                        <span className="material-symbols-outlined text-xs text-white">shield</span>
                      </div>
                      <span className="font-label text-xs font-bold text-[#2c2a1e]">Nirbhaya</span>
                    </div>
                  </div>

                  {/* Fake map */}
                  <div className="h-48 bg-gradient-to-br from-[#f5f0e0] to-[#e8d5df] relative">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="material-symbols-outlined text-5xl text-[#8d9d4f]/20">map</span>
                    </div>
                    {/* Map dots */}
                    <div className="absolute top-8 left-10 w-2.5 h-2.5 bg-[#8d9d4f] rounded-full animate-pulse"></div>
                  ...
                  <div className="px-5 py-5 flex flex-col items-center gap-3">
                    ...
                    <p className="font-label text-[10px] text-[#3a3520]/40 text-center">Tap for emergency alert</p>
                  </div>

                  {/* Bottom nav */}
                  <div className="flex justify-around px-4 py-3 border-t border-[#f5f0e0]">
                    {['home', 'map', 'sos', 'group', 'person'].map((ic, i) => (
                      <span key={i} className={`material-symbols-outlined text-lg ${i === 0 ? 'text-[#8d9d4f]' : 'text-[#3a3520]/30'}`}>{ic}</span>
                    ))}
                  </div>
                </div>
              </div>
