...
const createIcon = (type) => {
    ...
    if (t === 'police') {
        ...
        // Safezone / Crowd
        bgColor = 'bg-[#7a8a42]/10 border-[#7a8a42]/20';
        iconName = 'home';
        colorClass = 'text-[#7a8a42]';
    }
...
const userIcon = new L.DivIcon({
    ...
    <div class="w-7 h-7 rounded-full bg-white shadow-lg flex items-center justify-center z-10 border-2 border-[#7a8a42]">
      <div class="w-3.5 h-3.5 rounded-full bg-[#7a8a42]"></div>
    </div>
  </div>`,
    iconSize: [48, 48],
    iconAnchor: [24, 24]
